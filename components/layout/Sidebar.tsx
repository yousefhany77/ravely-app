...
function Sidebar() {
  ...
  return (
    <div
      ref={menuRef}
      className="bg-darkest  flex flex-col items-center text-light-gray gap-6  capitalize"
    >
      <Link href={"/"}>
      ...
      <span
        className="my-3 cursor-pointer md:hidden flex items-center self-start ml-5"
