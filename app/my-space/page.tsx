...
export default async function Home() {
  ...
  return (
    <main className="text-white w-full flex flex-col  p-10">
      <h2 className="capitalize text-xl lg:text-3xl font-extrabold text-white  w-fit my-6 ">Continue Watching</h2>
      <ConintueWatching />

      <section className="h-full  text-white  w-full  ">
        <h2 className="capitalize text-xl lg:text-3xl font-extrabold text-white  w-fit my-6 ">Trending</h2>
